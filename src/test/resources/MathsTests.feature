Feature: Testing calculations done by the maths module
  ...
  09R threshold.
    ...
    When He adds an obstacle 2853 m from the left and 500 m from the right, of height 25 and 20 from the centreline
    And with blast allowance 300
  ...
  from 09L threshold.
    ...
    And The values1 for 09L are 3902, 3902, 3902, 3595, 09, L and 306
    And The values2 for 27R are 3884, 3962, 3884, 3884, 27, R and 0
    When He adds an obstacle 3546 m from the left and 50 m from the right, of height 20 and 20 from the centreline
    And with blast allowance 300
